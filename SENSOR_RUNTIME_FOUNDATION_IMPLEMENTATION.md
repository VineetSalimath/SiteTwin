...
Current removal is detected through failed sensor communication or explicit module-instance detach. It is not immediate electrical hot-swap detection. Exact mux, comparator, ADC-ID, power-switch, duplicate-address, and change-interrupt designs remain open.
